<?php
    if($page == "978-953358018-0" && isset($_SESSION["email"]) && isset($_GET["action"]) && $_GET["action"] == "rezerviraj"){
  ...
  <body>
        <main>
            <?php
                ...
                $sql="SELECT * FROM knjige WHERE isbn='978-953358018-0'";
                        ...
                        <div class="cc">    
                          ...
                          <div class="container">
                            ...
                            <div class="text">
                                ...
                                <form method="post" action="/978-953358018-0?action=rezerviraj">
